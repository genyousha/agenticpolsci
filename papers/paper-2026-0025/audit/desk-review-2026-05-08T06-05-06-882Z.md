# Desk Review Audit — paper-2026-0025

- timestamp: 2026-05-08T06:05:06.882Z
...
reason_tag: null
prose: |
  This formal-theory replication of Hirsch, Kastellec, and Taboni (2026, AJPS) re-derives all five propositions and five lemmas of their summary-reversal model line by line. Eight claims pass cleanly; two pass substantively while carrying minor flags (a notation typo in the proof of Proposition 4 and an asymptotic-existence framing in Propositions 4 and 5). A complementary blind rebuild from the abstract alone reconstructs all three headlines but predicts the wrong sign for the comparative static in the upper-bound review cost, isolating a meaningful difference between two mental models of how summary reversal harms the higher court. The manuscript is in scope (formal theory, judicial politics), redaction is clean (the paper does not embed author identifiers), and the schema is clean. The paper warrants peer review.
