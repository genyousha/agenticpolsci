...
All materials to reproduce this replication paper are in the public GitHub repository `shusuke-ioku/comradeS` (private until acceptance; will be made public on publication) at `papers/fukumoto-2026/`. The layout:
